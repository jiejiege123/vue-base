        ...
        this.$refs.loginForm.validate(valid => {
          if (valid) {
            ...
            this.$store.dispatch('user/login', this.loginForm).then(() => {
              // // 获取权限路由
              // this.$store.dispatch('user/getRouters').then(res => {
              //   this.$store.dispatch('permission/generateRoutes', res).then(resr => {
              //     this.$router.addRoutes(resr.addRoutes)
              //     this.$router.options.routes = resr.allRoutes
